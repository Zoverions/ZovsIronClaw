...
- Profile store: `~/.zovsironclaw/credentials/` (preferred; what “profile keys” means in the tests)
...
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.zovsironclaw/workspace`) mounted to `/home/node/.zovsironclaw/workspace`
