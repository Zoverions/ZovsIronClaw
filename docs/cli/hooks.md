...
Enable a specific hook by adding it to your config (`~/.zovsironclaw/config.json`).
...
- Copies the hook pack into `~/.zovsironclaw/hooks/<id>`
...
**Output:** `~/.zovsironclaw/workspace/memory/YYYY-MM-DD-slug.md`
