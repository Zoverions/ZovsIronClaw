...
- `<workspace>/.zovsironclaw/extensions/*.ts`
- `<workspace>/.zovsironclaw/extensions/*/index.ts`

3. Global extensions

- `~/.zovsironclaw/extensions/*.ts`
- `~/.zovsironclaw/extensions/*/index.ts`
...
- `~/.zovsironclaw/mpm/plugins.json`
- `~/.zovsironclaw/mpm/catalog.json`
- `~/.zovsironclaw/plugins/catalog.json`
...
openclaw plugins install <path>                 # copy a local file/dir into ~/.zovsironclaw/extensions/<id>
...
- `openclaw plugins install <npm-spec>` uses `npm pack`, extracts into `~/.zovsironclaw/extensions/<id>/`, and enables it in config.
