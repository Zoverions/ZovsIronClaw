...
OpenClaw uses a dedicated workspace directory for the agent. Default: `~/.zovsironclaw/workspace` (configurable via `agents.defaults.workspace`).
...
```bash
cp docs/reference/templates/AGENTS.md ~/.zovsironclaw/workspace/AGENTS.md
cp docs/reference/templates/SOUL.md ~/.zovsironclaw/workspace/SOUL.md
cp docs/reference/templates/TOOLS.md ~/.zovsironclaw/workspace/TOOLS.md
```

3. Optional: if you want the personal assistant skill roster, replace AGENTS.md with this file:

```bash
cp docs/reference/AGENTS.default.md ~/.zovsironclaw/workspace/AGENTS.md
```
