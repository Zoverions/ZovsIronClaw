...
- The gateway container is the source of truth for sessions (`~/.zovsironclaw/agents/<agentId>/sessions/`).
...
- Agent workspace access: `workspaceAccess: "none"` (default) uses `~/.zovsironclaw/sandboxes`
