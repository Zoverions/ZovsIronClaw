...
Then update your OpenClaw config (`~/.zovsironclaw/zovsironclaw.json`):
...
chromium-browser --headless --no-sandbox --disable-gpu \
  ...
  --user-data-dir=$HOME/.zovsironclaw/browser/openclaw/user-data \
  about:blank &
```
...
[Service]
ExecStart=/snap/bin/chromium --headless --no-sandbox --disable-gpu --remote-debugging-port=18800 --user-data-dir=%h/.zovsironclaw/browser/openclaw/user-data about:blank
Restart=on-failure
RestartSec=5
